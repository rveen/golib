...
//
// ordinary_fs / [versioned_fs] / dir(handle index.*, readme.*) [/ path(into data/ document file)]
// ordinary_fs / [versioned_fs] / file(mime/data/document) [/ path(into data / document file)]
//
...
func (fs *fileSystem) GetRaw(path, rev string) (*types.FileEntry, error) {
